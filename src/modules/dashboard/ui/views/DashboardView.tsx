...
const DashboardView = () => {
  const { user: currentUser, canManageUsers, canManageProjects, isSuperAdmin } =
    useAuth()
  ...
  const canViewIncentivesTab =
    isAdmin || userRole.toUpperCase() === 'FINANCE_HR' || isProjectManager || isSuperAdmin
    ...
    const loadAdminDashboard = async () => {
      ...
      try {
        ...
        const payload: DashboardFilterPayload = isDefaultOrToday
          ...
          : {
              ...basePayload,
              ...(dateRange.start ? { date_from: dateRange.start.slice(0, 10) } : {}),
