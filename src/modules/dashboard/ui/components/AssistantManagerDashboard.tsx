...
import type { TrackerRow, DashboardSummary, TaskRef } from '../../../dashboard/types';
    ...
    const fetchDashboard = async () => {
      ...
      try {
        ...
        if (res.data && res.data.status === 200) {
          ...
          tasks.forEach((task) => {
            if (task.task_id) taskMap[String(task.task_id)] = task.task_name || '-';
          });
          ...
          setStats({
            ...
            latestQc: tracker
              ...
              .map((row) => ({
                ...
                date: typeof row.date_time === 'string' ? (row.date_time.split(' ')[0] ?? '-') : '-',
    ...
    <div className="space-y-6 max-w-6xl mx-auto pb-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <div className="bg-white rounded-xl shadow p-6 flex flex-col items-start border border-slate-100">
          ...
          <div className="text-2xl font-bold">{stats.billableHours.toFixed(2)}</div>
