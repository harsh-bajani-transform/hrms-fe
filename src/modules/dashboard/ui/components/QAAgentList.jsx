                              ...
                              >
                                ...
                                <td className="px-4 py-3 text-center">
                                  <button
                                    ...
                                    className="px-3 py-1.5 bg-blue-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-md transition-colors flex items-center gap-1.5 mx-auto cursor-pointer"
                                  >
