...
export interface CustomSelectProps<T extends SelectValue = SelectValue> {
  value: T
...
const CustomSelect = <T extends SelectValue = SelectValue>({
  value,
  onChange,
  options,
  icon: Icon,
    ...
    <div className={`relative w-full ${className}`} ref={dropdownRef}>
      <button
        ...
        className={`
          ...
          ${disabled ? 'border-slate-200 bg-slate-50 cursor-not-allowed opacity-60' : 'border-slate-200 hover:bg-slate-50 hover:border-blue-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500'}
        `}
      >
