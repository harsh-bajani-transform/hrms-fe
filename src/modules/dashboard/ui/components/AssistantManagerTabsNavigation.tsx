...
interface AssistantManagerTabsNavigationProps {
  activeTab: string;
  setActiveTab: (tabId: string) => void;
}

const AssistantManagerTabsNavigation: React.FC<
  AssistantManagerTabsNavigationProps
            ...
            <button
              ...
              className={
                ...
                (isActive
                  ...
                  : "bg-white border border-slate-200 text-slate-600 hover:text-blue-600 hover:border-slate-300 shadow-sm")
              }
              title={tab.label}
            >
