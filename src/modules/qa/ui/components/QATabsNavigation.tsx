...
export interface QATabsNavigationProps {
  activeTab: QATabId
  setActiveTab: Dispatch<SetStateAction<QATabId>>
}

const tabs: TabDef[] = [
  { id: 'overview', label: 'Overview', icon: LayoutGrid },
  { id: 'billable_report', label: 'Billable Report', icon: Briefcase },
  { id: 'audit_report', label: 'QC Report', icon: FileCheck },
  { id: 'afd_management', label: 'AFD Management', icon: FileWarning },
...
const QATabsNavigation = ({
  activeTab,
  setActiveTab,
}: QATabsNavigationProps) => {
  return (
